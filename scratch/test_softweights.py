...
def main():
    ...
    csv_path = PROJECT_ROOT / "models" / "test_predictions_resnet18_softweights.csv"
    ...
    plt.title('Test Confusion Matrix (Raw)')
    raw_cm_path = PROJECT_ROOT / "models" / "test_cm_raw_resnet18_softweights.png"
    ...
    plt.ylabel('True')
    plt.xlabel('Predicted')
    plt.title('Test Confusion Matrix (Normalized by True)')
    norm_cm_path = PROJECT_ROOT / "models" / "test_cm_norm_resnet18_softweights.png"
